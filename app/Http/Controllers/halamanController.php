...
class halamanController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        halaman::create($data);
        return redirect()->route('halaman.index')->with('success','succesfully added');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('halaman.index')->with('success','succesfully updated');
    }
    ...
    public function destroy(string $id)
    {
       ...
       return redirect()->route('halaman.index')->with('success','succesfully deleted'); 
    }
}
