        ...
        <form action="{{ route('education.store') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input
                    ...
                    placeholder="Jurusan" value="{{ Session::get('judul') }}"
                />
            </div>
            <div class="mb-3">
                ...
                <input
                    ...
                    id="info1"
                    aria-describedby="helpId"
                    placeholder="Nama Sekolah" value="{{ Session::get('info1') }}"
                />
            </div>
            <div class="mb-3">
                ...
                <input
                    ...
                    id="info2"
                    aria-describedby="helpId"
                    placeholder="IPK/Nilai" value="{{ Session::get('info2') }}"
                />
            </div>
            <div class="mb-3">
                <div class="row">
                    ...
                    <div class="col-auto"><input type="date" class="form-control form-control-sm" name="tanggal_mulai"
                        placeholder="dd/mm/yyyy" value="{{ Session::get('tanggal_mulai') }}"></div>
                    <div class="col-auto">Tanggal Akhir</div>
                    <div class="col-auto"><input type="date" class="form-control form-control-sm" name="tanggal_akir"
                        placeholder="dd/mm/yyyy" value="{{ Session::get('tanggal_akir') }}"></div>
                </div>
