        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    ...
                    <div class="subheading mb-5">
                        {{ get_meta_value('_kota')}} · {{ get_meta_value('_provinsi')}} · {{ get_meta_value('_nomor')}} · <a href="mailto:name@email.com">{{ get_meta_value('_email') }}</a>
                    </div>
            ...
            <section class="resume-section" id="experience">
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        ...
                        <div class="flex-shrink-0"><span class="text-primary">{{ $item->tanggal_mulai_kerja }} - {{ $item->tanggal_akir_kerja }}</span></div>
                    </div>   
                    @endforeach
                </div>
            </section>
            ...
            <section class="resume-section" id="education">
                <div class="resume-section-content">
                    ...
                    <div class="d-flex flex-column flex-md-row justify-content-between mb-5">
                        <div class="flex-grow-1">
                            <h3 class="mb-0">{{ $item->info1 }}</h3>
                            <div class="subheading mb-3">{{ $item->info3 }}</div>
                            <div>{{ $item->judul }}</div>
                            <p>{{ $item->info2 }}</p>
                        </div>
                        <div class="flex-shrink-0"><span class="text-primary">{{ $item->tanggal_mulai_kerja}} - {{ $item->tanggal_akir_kerja }}</span></div>
